            ...
            <div style={styles.avatar_wrap}>
                {
                    props.option.material_icon
                        ? <Avatar alt={props.option.primary} style={styles.avatar}><Icon>{props.option.material_icon}</Icon></Avatar>
                        : props.option.uri_icon
                            ? <Avatar alt={props.option.primary} src={props.option.uri_icon} style={styles.avatar}></Avatar>
                            : <Avatar style={styles.avatar}>{props.option.primary[0]}</Avatar>
                }
            </div>
