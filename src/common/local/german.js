...
const TRANSLATION_GERMAN = {
    ...
    incremental_result_debounce: 'Inkrementelle Erebnisse debounce time [ms]',
    ...
    linux_system_description: 'Dieses Modul ermöglicht einige fundamantale Linux-Systembefehle',
    reboot: 'Neustart',
