...
const TRANSLATION_ITALIAN = {
    ...
    incremental_result_debounce: 'Risultati incrementali debounce time [ms]',
    ...
    system_commands: 'Comandi sistema',
    system_commands_description: 'Questo modulo fornirà alcuni comandi di sistema fondamentali',
    reboot: 'Ricomincia',
    shutdown: 'Spengna',
    ...
    entries: 'Inserimenti',
    name: 'Nome',
    default_quality: 'Priorità predefinita',
