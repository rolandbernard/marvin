...
const TRANSLATION_GERMAN = {
    ...
    incremental_result_debounce: 'Inkrementelle Erebnisse debounce time',
    ...
    system_commands_description: 'Dieses Modul ermöglicht einige fundamantale Linux-Systembefehle',
    reboot: 'Neustart',
    ...
    entries: 'Einträge',
    name: 'Name',
    default_quality: 'Standardpriorität',
    ...
    command: 'Befehle',
    command_description: 'Mit diesem Modul können Sie Shell-Befehle ausführen',
    prefix: 'Präfix',
    execute: 'Ausführen',
    execute_in_terminal: 'Im Terminal ausführen',
